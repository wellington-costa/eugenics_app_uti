...
CREATE TABLE IF NOT EXISTS `pacientes` (
  ...
  `nome` varchar(50) NOT NULL,
  `data_nasc` timestamp NULL DEFAULT NULL,
  `municip_orig` varchar(30) NOT NULL,
  `sexo` varchar(30) NOT NULL,
  `prontuario` varchar(10) NOT NULL,
  `arq_prontuario` text,
  `setor_entrada` varchar(30) NOT NULL,
  `data_inter` timestamp NULL DEFAULT NULL,
  `diagnostico` text,
  `status` int NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `FK_pacientes_hospitais` (`id_hospital`),
  KEY `FK_pacientes_leito` (`id_leito`),
  CONSTRAINT `FK_pacientes_hospital` FOREIGN KEY (`id_hospital`) REFERENCES `hospitais` (`id`),
  CONSTRAINT `FK_pacientes_leito` FOREIGN KEY (`id_leito`) REFERENCES `leitos` (`id`)
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  KEY `FK_usuarios_pacientes` (`id_hospital`),
  CONSTRAINT `FK_usuarios_clientes` FOREIGN KEY (`id_empresa`) REFERENCES `empresas` (`id`),
  CONSTRAINT `FK_usuarios_pacientes` FOREIGN KEY (`id_hospital`) REFERENCES `hospitais` (`id`),
...
CREATE TABLE IF NOT EXISTS `paciente` ()ENGINE=InnoDB AUTO_INCREMENT=277 DEFAULT CHARSET=latin1;
