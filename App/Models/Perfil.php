...
class Perfil extends Model
{
    ...
    public function perfis($idUsuarioLogado = false, $idUsuarioEditado = false, $idPerfilUsuarioLogado = false)
    {
        ...
        /**
         * Se o usuário for um medico, traz apenas o perfil de vendedor.
         * Pois somente o administrador pode cadastrar usuarios com outros perfis.
         */
        if ($idPerfilUsuarioLogado && $idPerfilUsuarioLogado == $medico) {
            return $this->query("SELECT * FROM perfis WHERE id NOT IN({$superAdmin},{$administrador},{$medico})");
        }
