...
<head>
    ...
    <?php else: ?>
        <meta property="og:title" content="Eugenics">
        <meta property="og:site_name" content="Eugenics">
    <?php endif; ?>

    <meta property="og:description" content="Eugenics">
    ...
    <div class="sidebar" data-color="black" data-active-color="danger">
        ...
        <div class="logo">
          ...
          <span style="color:#00cc66;">&nbsp;&nbsp;&nbsp;
            ...
            <?php else: ?>
                <b style="opacity:0.70">Eugenics</b>
            <?php endif; ?>
